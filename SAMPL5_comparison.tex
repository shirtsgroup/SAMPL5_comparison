...
GROmacs~\citep{topogromacs}, and {\tt amber2lmp}, a script converting
between LAMMPS and AMBER files. There are other resources which do not
convert directly, but will build the same system in multiple programs,
such as CHARMM-GUI.~\citep{lee_charmm-gui_2016}
