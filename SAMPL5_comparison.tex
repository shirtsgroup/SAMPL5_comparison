...
\titlerunning{Lessons learned comparing molecular dynamics engines}        % if too long for running head
...
We find that the energy calculations for all molecular dynamics
engines for this molecular set agree to a better than 0.1\% relative
absolute energy for all energy components, and in most cases an order
of magnitude better, when reasonable choices are made for different
cutoff parameters. However, there are some surprising sources of
statistically significant differences. Most importantly, different
choices of Coulomb's constant between programs are one of the largest
sources of discrepancies in energies. We discuss the measures required
...
default simulation parameter values. Finally, we discuss what was required 
to automate this conversion and comparison.
...
that the simulations generate after the generation of an ensemble of
configurations. The comparison of the final experimental observables
calculated from simulation ensembles is the most fundamentally
important type of comparison, since it corresponds directly to
experiment.
...
Each statistical measure gives somewhat different information about
...
The energies generated using the `default' parameters defined above
...
The differences between single and double precision shown
...
\bibitem[{Muddana et~al(2014)Muddana, Fenley, Mobley, and
  Gilson}]{Muddana2014SAMPL4}
...
\bibitem[{Muddana et~al(2012)Muddana, Varnado, Bielawski, Urbach, Isaacs,
  Geballe, and Gilson}]{Muddana2012a}
...
\bibitem[{Geballe et~al(2010)Geballe, Skillman, Nicholls, Guthrie, and
  Taylor}]{geballe_sampl2_2010}
...
\bibitem[{Guthrie(2009)}]{guthrie_blind_2009}
...
\bibitem[{Monroe and Shirts(2014)}]{Monroe2014}
...
\bibitem[{Yin et~al(2016)Yin, Henriksen, Slochower, Shirts, Chiu, Mobley, and
  Gilson}]{SAMPL5Overview}
...
\bibitem[{Case et~al(2014)Case, Babin, Berryman, Betz, Cai, Cerutti,
  Cheatham~III, Darden, Duke, Gohlke, Goetz, Gusarov, Homeyer, Janowski, Kaus,
  Kolossv\'{a}ry, Kovalenko, Lee, LeGrand, Luchko, Luo, Madej, Merz, Paesani,
  Roe, Roitberg, Sagui, Salomon-Ferrer, Seabra, Simmerling, Smith, Swails,
  Walker, Wang, Wolf, Wu, and Kollman}]{Amber14}
...
\bibitem[{Hess et~al(2008)Hess, Kutzner, Spoel, and
  Lindahl}]{hess_gromacs_2008}
...
\bibitem[{Plimpton(1995)}]{plimpton_fast_1995}
Plimpton S (1995) Fast {Parallel} {Algorithms} for {Short}-{Range} {Molecular}
  {Dynamics}. Journal of Computational Physics 117(1):1--19

\bibitem[{Bowers et~al(2006)Bowers, Chow, Xu, Dror, Eastwood, Gregersen,
  Klepeis, Kolossvary, Moraes, Sacerdoti, Salmon, Shan, and
  Shaw}]{bowers_scalable_2006}
...
\bibitem[{Paliwal and Shirts(2013)}]{Paliwal2013}
...
\bibitem[{Sousa~da Silva and Vranken(2012)}]{sousa_da_silva_acpype_2012}
Sousa~da Silva AW, Vranken WF (2012) {ACPYPE} - {AnteChamber} {PYthon} {Parser}
  {interfacE}. BMC Research Notes 5:367

\bibitem[{Crowley et~al(2009)Crowley, Williamson, and
  Walker}]{crowley_chamber:_2009}
...
\bibitem[{Vermaas et~al(2016)Vermaas, Hardy, Stone, Tajkhorshid, and
  Kohlmeyer}]{vermaas_topogromacs:_2016}
...
\bibitem[{Lee et~al(2016)Lee, Cheng, Swails, Yeom, Eastman, Lemkul, Wei,
  Buckner, Jeong, Qi, Jo, Pande, Case, Brooks, MacKerell, Klauda, and
  Im}]{lee_charmm-gui_2016}
...
\bibitem[{Allen and Tildesley(1989)}]{AllenAndTildesley}
Allen MP, Tildesley DJ (1989) Computer Simulation of Liquids. Clarendon Press,
  New York, NY, USA

\bibitem[{Shirts et~al(2007)Shirts, Mobley, Chodera, and
  Pande}]{shirts_accurate_2007}
...
\bibitem[{Wu and Brooks(2005)}]{wu_isotropic_2005}
...
\bibitem[{Essmann et~al(1995)Essmann, Perera, Berkowitz, Darden, Lee, and
  Pedersen}]{essmann_smooth_1995}
...
\bibitem[{Gan and Gibb(2013)}]{gan_guest-mediated_2013}
...
\bibitem[{Veld et~al(2007)Veld, Ismail, and Grest}]{veld_application_2007}
...
% LocalWords:  uh Bohr's runfiles tgz txt gzipped PMEMD prec CHE virial veld
% LocalWords:  ewald
